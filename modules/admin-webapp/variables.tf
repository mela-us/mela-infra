...
variable "admin_app_repository_url" {
  description = "The URL of the Git repository for the admin web application."
  type        = string
}

variable "admin_app_branch" {
  description = "The branch of the Git repository for the admin web application."
  type        = string
}
